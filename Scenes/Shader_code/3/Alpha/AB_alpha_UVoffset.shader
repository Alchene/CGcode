    ...
    SubShader {
        ...
        Pass {
            ...
            half4 frag(VertexOutput i) : COLOR { 
				...
				half4 var_NoiseTex = tex2D(_NoiseTex,TRANSFORM_TEX(i.uv1, _NoiseTex));
               // half3 frgb = var_Maintex.rgb
                half noise = max(lerp(1.0,var_NoiseTex * 2.0 , _NoiseInt),0.0);
                half opacity = (1-var_Maintex.a) * noise*_Opacity;
